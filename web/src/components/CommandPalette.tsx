...
const ROUTES: { path: string; label: string; keywords: string[] }[] = [
  ...
  { path: "/outbounds", label: "Outbounds", keywords: ["egress", "proxy"] },
  { path: "/routing", label: "Routing Rules", keywords: ["routes", "policy"] },
  { path: "/balancers", label: "Balancers", keywords: ["load", "balance"] },
  { path: "/plans", label: "Plans", keywords: ["pricing", "subscription"] },
  ...
  { path: "/reality-scanner", label: "Reality Scanner", keywords: ["sni", "probe", "scan"] },
  ...
  { path: "/decoy-website", label: "Decoy Website", keywords: ["fake", "probe", "camouflage"] },
  { path: "/migration", label: "Auto Migration", keywords: ["failover", "health"] },
  { path: "/probing-protection", label: "Probing Protection", keywords: ["gfw", "block", "detect"] },
  ...
  { path: "/tls-tricks", label: "TLS Tricks", keywords: ["fragment", "isp", "anti-dpi"] },
  ...
  { path: "/evasion", label: "Evasion Profiles", keywords: ["anti-dpi", "fragment"] },
  { path: "/admins", label: "Admin Management", keywords: ["roles", "permissions"] },
  { path: "/audit", label: "Audit Log", keywords: ["history", "actions"] },
  { path: "/logs", label: "System Logs", keywords: ["debug", "error"] },
  { path: "/settings", label: "Settings", keywords: ["config", "branding"] },
];
