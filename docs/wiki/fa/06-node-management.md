...
| فیلد | توضیحات |
|------|---------|
| آدرس اندپوینت | دامنه/IP که کاربران به آن متصل می‌شوند |
| پورت اندپوینت | پورتی که کاربران به آن متصل می‌شوند |
| توضیحات | شرح (مثلاً "پشت CDN کلادفلر") |

زمانی از این استفاده کنید که نود پشت تانل، CDN یا ریلی باشد — IP واقعی نود با آدرس سمت کاربر متفاوت است.
