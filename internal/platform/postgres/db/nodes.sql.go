...
SELECT id, name, address, core, enabled_cores, status, usage_ratio, endpoint, region, country_code, ping_ms, location_auto, last_seen, cpu_percent, mem_percent, disk_percent, core_running, connections, core_version, agent_version, created_at FROM nodes WHERE id = $1
`
...
SELECT id, name, address, core, enabled_cores, status, usage_ratio, endpoint, region, country_code, ping_ms, location_auto, last_seen, cpu_percent, mem_percent, disk_percent, core_running, connections, core_version, agent_version, created_at FROM nodes ORDER BY created_at
`
