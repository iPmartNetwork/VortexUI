...
CREATE TABLE nodes (
    ...
    location_auto BOOLEAN NOT NULL DEFAULT TRUE,
...
CREATE TABLE inbounds (
    ...
    hop_interval       INTEGER NOT NULL DEFAULT 0,
    UNIQUE (node_id, tag)
);
...
-- v1.4.0: Protocol Groups for auto-protocol switching
...
CREATE INDEX idx_protocol_groups_node_id ON protocol_groups(node_id);
...
CREATE INDEX idx_isp_profiles_group_id ON isp_profiles(group_id);
...
CREATE INDEX idx_switch_events_timestamp ON switch_events(timestamp DESC);
